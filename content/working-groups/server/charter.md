...
## Version 1.3 – effective December 4, 2023
...
(6) it provides public documentation explaining the steps that Certificate Issuers need to take in order to have their CA certificates trusted or distrusted by the membership-qualifying software product; ***and***
...
(5) Names and email addresses of employees who will participate in the SCWG and Forum as representatives; ***and***
...
(2) The URLs of three web pages that comply with section 2.2 of the TLS Baseline Requirements (respectively secured with a valid, a revoked, and an expired certificate); ***and***
...
(5) it ceases to provide public documentation explaining the steps that Certificate Issuers need to take in order to have their CA certificates trusted or distrusted by the membership-qualifying software product; ***or***
...
(3) fifteen (15) months have elapsed since the end of the audit period of its last membership-qualifying audit; ***or***
...
Source: <https://github.com/cabforum/forum/blob/main/SCWG-charter.md>