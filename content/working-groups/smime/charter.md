...
o            WebTrust for CAs v.2.0 or newer; or

o            ETSI EN 319 411-1, which includes normative references to ETSI EN 319 401 (the latest version of the referenced ETSI documents should be applied).

These audit reports must also meet the following requirements:

o            They must report on the operational effectiveness of controls for a historic period of at least 60 days;

o            No more than 27 months have elapsed since the beginning of the reported-on period and no more than 15 months since the end of the reported-on period; and

o            The audit report was prepared by a natural or legal person that is duly authorized or licensed to conduct audits according to the relevant audit criteria or attestation scheme used.
...
2.           A Certificate Consumer eligible for voting membership in the SMCWG must produce and maintain a mail user agent (web-based or application based) or email service provider that processes S/MIME certificates.
...
o            Confirmation that the applicant satisfies at least one (1) of the membership eligibility criteria (and if it satisfies more than one (1), indication of the single category under which the applicant wishes to apply).

o            The organization name, as they wish it to appear on the Forum Web site and in official Forum documents.

o            URL of the applicant’s main Web site.

o            Names and email addresses of designated representatives who will participate in the Working Group and Forum on behalf of the Member.

o            Emergency contact information for security issues related to certificate trust.
...
o            URL of the current qualifying audit report.

o            Links or references to issued end-entity certificates that demonstrate them being treated as valid by a Certificate Consumer Member.
...
3.           its S/MIME certificates are not treated as valid by any Certificate Consumer Member of the SMCWG.
