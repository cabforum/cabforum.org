...
# Meeting 33 – Beijing China {.line874}
...
# Day 1 – Tuesday, 16 September 2014 {#Day_1\_-\_Tuesday.2C_16_September_2014}

## Extended Validation Working Group Discussions (prepared by Robin Alden) {#Extended_Validation_Working_Group_Discussions\_.28prepared_by_Robin_Alden.29}
...
## Code Signing Working Group Discussions {#Code_Signing_Working_Group_Discussions}
...
## Certificate Policy Review Working Group Discussions {#Certificate_Policy_Review_Working_Group_Discussions}
...
# Day 2 – Wednesday, 17 September 2014 {#Day_2\_-\_Wednesday.2C_17_September_2014}
...
## Cert Policy/Security Review {#Cert_Policy.2BAC8-Security_Review}
...
## Browser Updates {#Browser_Updates}
...
Shipped in Firefox 31 in July. We continue to maintain a wiki page with behavioral changes, and things for CAs to fix:
...
We now have an agreed plan of record for our revocation strategy:
...
As noted in the last meeting, key pinning shipped in Firefox 32 for Mozilla and Twitter. It will ship in Firefox 33 for Google.

HPKP is targeted for implementation by the end of this month (September): If it stays on track, it would ship in Firefox 35 in January 2015.

has details of how our implementation works.
...
We hope to remove the “or no EKU” part for end-entity certs (some people are skeptical of this) – .
...
Kathleen has written a new document which makes clear some of our expectations regarding Baseline Requirements audits, and the disclosure of the results of the same:
...
is our tracking bug for BR issues; its dependency list is a list of instances where CAs have issued certs which are not compliant with the BRs. Mozilla is in direct contact with those that have violations.

**Mozilla 7. SHA-1 Deprecation**

Issuing SHA-1 certs is now a Problematic Practice: .

We observe Microsoft’s and Google’s strategies with interest, but are not planning any UI changes of our own at the moment. We may well implement code which refuses to accept SHA-1 certs which fall outside Microsoft’s parameters:
...
is our recent blog post on this topic.
...
We are also moving towards marking any chain which has anything less than 2048 in it as untrusted in the UI: This is on our list of future projects, but is not currently resourced, which means we have no solid timeline for implementation yet.

**Mozilla 9. salesforce.com**

We have a consultant working to move management of our CA data onto the salesforce.com platform. has the gory details for those interested.
...
– request for feedback from CAs and auditors.
...
For CAs who haven’t completed the action items for the May CA Communication, then we will aim to get updated status on those (with only a couple of exceptions, that does not refer to CAs who are at this meeting). See .
...
- BR audit expectations:

- BR issues tracking bug:
...
## Updates from CAs on Efforts to Reduce Prevalence of SHA1 Certificates {#Updates_from_CAs_on_Efforts_to_Reduce_Prevalence_of_SHA1_Certificates}
...
## Guideline review for CT implementation {#Guideline_review_for_CT_implementation}
...
## Discussion of CAA Records {#Discussion_of_CAA_Records}
...
## Review of draft Ballot 133 – Insurance for EV Issuers {#Review_of_draft_Ballot_133\_-\_Insurance_for_EV_Issuers}
...
## Report from WebTrust and ETSI {#Report_from_WebTrust_and_ETSI}
...
## CABF Questions & Answers – ETSI report from Iñigo Barreira {#CABF_Questions\_.26_Answers\_.2BIBM_ETSI_report_from_I.2BAPE-igo_Barreira}

### **Answers to ETSI questions** {.line867}
...
Q9: from the browsers perspective and the CABF as an organization as well, how to know if an auditor and an audit are accredited? The national accreditation body should be contacted to identify “conformity assessment bodies” that have been accredited by that national body. Some further guidance is provided at:
...
## Status of the EIDAS Regulation {#Status_of_the_EIDAS_Regulation}
...
### **General principals for TSPs** {.line891}
...
### **Role of the supervisory body** {.line862}
...
### **eIDAS-electronic signatures and seals** {.line891}
...
### **Final slide on timing implementation** {.line891}

- – Entry into force in September 2014
- – In 2 years has to be implemented by TSPs
- – In 2 more years for eIDs

# Day 3 – Thursday, 18 September 2014 {#Day_3\_-\_Thursday.2C_18_September_2014}

## Review of Ballots (Ben) {#Review_of_Ballots\_.28Ben.29}

(Prepared by Rick) Ben gave an updated on updates he made to open ballots in the last 24 hours.

### SHA-1 deprecation (Ballot 118) {#SHA-1_deprecation\_.28Ballot_118.29}
...
### EV Insurance (Ballot 133) {#EV_Insurance\_.28Ballot_133.29}
...
### RFC 5280 proposal (Ballot 134) {#RFC_5280_proposal\_.28Ballot_134.29}

Nothing changed, just assigned a ballot number

### CAA (Ballot 125) {#CAA\_.28Ballot_125.29}
...
### ETSI auditor qualifications (Ballot 135) {#ETSI_auditor_qualifications\_.28Ballot_135.29}

Nothing changed, just assigned a ballot number

## Discussion of Critical Extension to Technically Constrain SSL for Non-Browsers and Status of OCSP Stapling {#Discussion_of_Critical_Extension_to_Technically_Constrain_SSL_for_Non-Browsers_and_Status_of_OCSP_Stapling}
...
## Discuss Scope of CA/Browser Forum Work, Purpose, Bylaws, Project Lifecycle Revisions, Working Group Charters, Changes {#Discuss_Scope_of_CA.2BAC8-Browser_Forum_Work.2C_Purpose.2C_Bylaws.2C_Project_Lifecycle_Revisions.2C_Working_Group_Charters.2C_Changes}
...
## Comparison of Trust Anchor Embedding Programs {#Comparison_of_Trust_Anchor_Embedding_Programs}
...
## Bugzilla System {#Bugzilla_System}
...
## Future Improvements to the Implementation of SSL/TLS {#Future_Improvements_to_the_Implementation_of_SSL.2BAC8-TLS}
...
## Overview of Information Sharing to Combat Security Threats – Why and How do We Share Information? {#Overview_of_Information_Sharing_to_Combat_Security_Threats\_-\_Why_and_How_do_We_Share_Information.3F}
...
## Identity Vetting Remotely via Audio/Visual System, CABF Centre Database for Malware Signing Risk Database {#Identity_Vetting_Remotely_via_Audio.2BAC8-Visual_System.2C_CABF_Centre_Database_for_Malware_Signing_Risk_Database}
...
## Presentation of Vice Chair Candidates {#Presentation_of_Vice_Chair_Candidates}
...
## 360 Browser Presentation {#A360_Browser_Presentation}
