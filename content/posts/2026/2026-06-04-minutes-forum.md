...
tags:
  - Minutes
  - Forum
title: 2026-06-04 Minutes of the Forum
type: post
---
...
### Approval of May 21st Meeting

Minutes approved

### Presentations: (attached)

- Digital Identity for Agentic AI (Jason Soroko). [See presentation.](<https://www.cabforum.org/uploads/CAB_Demo_JasonSoroko (002).pdf>)
- Merkle Tree Certificates (Aaron Gable). [See here.](<https://www.cabforum.org/uploads/CABF MTCs Explainer 2026-06-04.pdf>)
- Control based audits compared to other audits (Lilia Dubko, Tim Crawford, Eric Lin). [See here.](<https://www.cabforum.org/uploads/CPA Canada Control Testing Overview.pdf>)
- Tool for CAs – CT Submit (Rob Stradling). See: https://docs.google.com/presentation/d/1Hy6G9zSx0SLmAQK9qFKCP-wI_7jL5pCw1Q3ilT1LStk/edit?usp=sharing
