...
## Wednesday, 16 June 2021 – Plenary Meeting (Day 1) {#wednesday_16_june_2021\_-\_plenary_meeting_day_1.wp-block-heading}
...
### Future face to face meeting schedule {#future_face_to_face_meeting_schedule.wp-block-heading}
...
### Infrastructure WG Recap {#infrastructure_wg_recap.wp-block-heading}
...
## Server Certificate Working Group Meeting {#server_certificate_working_group_meeting.wp-block-heading}

Attendees: _As marked for the Wednesday meeting session above_

Jos called the meeting to order.

### Anti-Trust Statement {#anti-trust_statement.wp-block-heading}

Jos read the anti-trust statement.

### Approval of Previous Minutes {#approval_of_previous_minutes.wp-block-heading}
...
#### Change Management {#change_management.wp-block-heading}
...
#### Program Requirements {#program_requirements.wp-block-heading}
...
#### Testing {#testing.wp-block-heading}
...
#### Communications Reminder {#communications_reminder.wp-block-heading}
...
#### Kernel Mode Code Signing {#kernel_mode_code_signing.wp-block-heading}
...
#### Q and A {#q_and_a.wp-block-heading}
...
#### JSON Array of Partitioned CRLs {#json_array_of_partitioned_crls.wp-block-heading}
...
#### Root Inclusion Cases {#root_inclusion_cases.wp-block-heading}
...
#### CA Task Lists {#ca_task_lists.wp-block-heading}
...
#### CCADB Enhancements Now Tracked in Bugzilla {#ccadb_enhancements_now_tracked_in_bugzilla.wp-block-heading}

CCADB enhancements and bugs are now being tracked in Bugzilla –

#### Other Uses of Root Stores {#other_uses_of_root_stores.wp-block-heading}

Lists of curated roots are available in the CCADB –  – subject to license appearing there.

#### CCADB Enhancements {#ccadb_enhancements.wp-block-heading}
...
### Q&A discussion {#q_a_discussion.wp-block-heading}
...
## Thursday, 17 June 2021 – Server Certificate Working Group Meeting (Day 2) {#thursday_17_june_2021\_-\_server_certificate_working_group_meeting_day_2.wp-block-heading}
...
### Guest Speaker Prof. David Maimon: Evidence Based Cybersecurity {#guest_speaker_prof_david_maimonevidence_based_cybersecurity.wp-block-heading}
...
### Strategies for retiring older root CA certificates {#strategies_for_retiring_older_root_ca_certificates.wp-block-heading}
